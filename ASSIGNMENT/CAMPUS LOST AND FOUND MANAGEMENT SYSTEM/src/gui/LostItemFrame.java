...
/**
 * LostItemFrame provides the form interface to report a lost item on campus.
 */
public class LostItemFrame extends JFrame {
    ...
    public LostItemFrame(DashboardFrame dashboard) {
        this.parentDashboard = dashboard;

        setTitle("Campus Lost & Found - Report Lost Item");
    ...
    private void initComponents() {
        ...
        JPanel headerPanel = UIUtils.createHeaderPanel(
                "Report Lost Item",
                "Fill in the details of the item lost on campus"
        );
        ...
        formCard.add(UIUtils.createLabel("Location Lost *", UIUtils.FONT_BOLD), gbc);
        ...
        JButton btnSubmit = UIUtils.createStyledButton("Submit Report", UIUtils.COLOR_STATUS_LOST, Color.WHITE);
    ...
    private void submitForm() {
        ...
        Item item = new Item(name, desc, category, "Lost", location, sqlDate, reportedBy, contact);
